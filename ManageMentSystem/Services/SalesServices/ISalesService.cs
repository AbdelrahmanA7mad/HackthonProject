...
namespace ManageMentSystem.Services.SalesServices
{
    public interface ISalesService
    {
        ...
        Task<(List<Sale> Sales, int TotalCount, int TotalPages)> GetSalesPaginatedAsync(int page, int pageSize, string searchTerm, ManageMentSystem.Models.SalePaymentType? paymentType, DateTime? fromDate, DateTime? toDate);
